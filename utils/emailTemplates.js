export function buildSubscriptionEmail({ email, unsubscribeLink }) {
      ...
      <tr>
        <td align="center">
            ...
            <tr>
              <td style="padding:40px 32px;">
                ...
                <p style="margin:0 0 16px 0; font-size:16px; line-height:1.6; color:#4b5563;">
                  ...
                  At TMG GLOBAL, we're committed to helping businesses grow through innovative solutions 
                  and expert guidance.
                </p>
            ...
            <tr>
              <td style="background:#f9fafb; padding:24px 32px; border-top:1px solid #e5e7eb;">
                ...
                <p style="margin:0; font-size:12px; color:#9ca3af; text-align:center;">
                  © ${new Date().getFullYear()} TMG GLOBAL. All rights reserved.
                </p>
          ...
          <p style="margin:20px 0 0 0; font-size:12px; color:#9ca3af; text-align:center;">
            This email was sent to ${email} because you subscribed on TMG GLOBAL Website.
          </p>
  ...
  const text = `Welcome to TMG GLOBAL!
...
© ${new Date().getFullYear()} TMG GLOBAL
...
export function buildUnsubscribeEmail({ email = "", unsubscribeLink = null, supportEmail = "info@tmgdubai.com" } = {}) {
